...
<template>
  <div class="h-screen flex flex-col">
    <!-- Header -->
    <header class="flex items-center justify-between px-4 h-14 bg-gray-100 dark:bg-gray-900 border-b border-transparent dark:border-gray-800">
      <div>
    ...
    <div class="mt-4 overflow-auto bg-white dark:bg-gray-800 rounded-lg shadow">
      <AccountListView
        ...
        >
          ...
          <div class="flex items-center space-x-2">
            <input
              ...
              type="checkbox"
              class="h-4 w-4 appearance-none rounded-md border border-gray-400 dark:border-gray-500
                    checked:bg-primary-500 checked:border-primary-500 hover:bg-primary-300 dark:hover:bg-primary-400"
            />
            <label
              for="isDefault"
