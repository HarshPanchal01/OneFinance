  ...
  >
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg w-96 shadow-lg">
      ...
      <div class="flex justify-end space-x-2">
        <button
          class="px-4 py-2 bg-primary-50 dark:bg-primary-900/10 text-primary-600 dark:text-primary-400 hover:bg-primary-100 dark:hover:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded transition"
          @click="handleConfirm"
        >
          {{ confirmText }}
        </button>
